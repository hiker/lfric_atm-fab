...
echo 'current dir'
echo $PWD
imagerun mpirun -np 6 $FAB_WORKSPACE/gungho_model-mpif90-intel-classic/gungho_model configuration.nml
...
echo 'current dir'
echo $PWD
imagerun mpirun -np 1 $FAB_WORKSPACE/lfric_atm-mpif90-intel-classic/lfric_atm configuration.nml
